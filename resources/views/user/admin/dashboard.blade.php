    ...
    <script>
        $(document).ready(function () {
            new Morris.Bar({
                ...
                [
                  @foreach($dish as $d)
                    { year:'{{$d->dish}}'+'({{count($d->todaysOrderDish)}})', value:{{count($d->todaysOrderDish)}} },
                  @endforeach
                ],
            ...
            new Morris.Bar({
                ...
                data:
                    ...
                    [@foreach($waiter as $w)
                        { year:'{{$w->name}}'+'({{count($w->waiterOrdersToday)}})', value:{{count($w->waiterOrdersToday)}} },
                        @endforeach
                    ],
            ...
            new Morris.Bar({
                ...
                data:
                    ...
                    { year:'{{$k->name}}'+'({{count($k->kitchenOrderToday)}})', value:{{count($k->kitchenOrderToday)}} },
                        @endforeach
                    ],
